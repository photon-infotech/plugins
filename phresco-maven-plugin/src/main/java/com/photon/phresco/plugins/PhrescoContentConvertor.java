...
public class PhrescoContentConvertor extends PhrescoAbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
    	try {
    		...
    		if (infoFile.exists() && isGoalAvailable(infoFile.getPath(), Constants.PHASE_CONTENT_CONVERTOR) && getDependency(infoFile.getPath(), Constants.PHASE_CONTENT_CONVERTOR) != null) {
				PhrescoPlugin plugin = getPlugin(getDependency(infoFile.getPath(), Constants.PHASE_CONTENT_CONVERTOR), mavenSession, project, container);
