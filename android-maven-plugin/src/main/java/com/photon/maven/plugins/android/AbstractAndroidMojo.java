...
import static com.photon.maven.plugins.android.common.AndroidExtension.APKPERF;
...
public abstract class AbstractAndroidMojo extends AbstractMojo
{
     ...
     *
     * @parameter expression="${android.nativeLibrariesDirectory}" default-value="${project.basedir}/source/libs"
     */
     ...
     * <p>Corresponds to {@link com.photon.maven.plugins.android.configuration.Sdk#path}.</p>
     *
     ...
     * <code>&lt;sdk&gt;</code> configuration tag.</p>
     * <p>Corresponds to {@link com.photon.maven.plugins.android.configuration.Sdk#platform}.</p>
     *
     ...
     * <p>Corresponds to {@link com.photon.maven.plugins.android.configuration.Ndk#path}.</p>
     *
     ...
     */
	 ...
	 // Changes made to run the unit and functional in parallel
