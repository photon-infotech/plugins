...
public class DrupalCompile implements DirectoryWalkListener, PluginConstants {
	...
	private void handleProcesedFile() throws MojoExecutionException {
		try {
			File targetDir = new File(baseDir + DO_NOT_CHECKIN_FOLDER + File.separator +  TARGET);
