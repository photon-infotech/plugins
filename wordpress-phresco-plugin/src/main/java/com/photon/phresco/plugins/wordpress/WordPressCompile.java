...
public class WordPressCompile implements DirectoryWalkListener, PluginConstants {
	...
	private void handleProcesedFile() throws MojoExecutionException {
		try {
			File targetDir = new File(baseDir + File.separator + DO_NOT_CHECKIN_FOLDER + File.separator +  TARGET);
